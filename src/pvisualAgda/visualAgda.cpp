...
bool visualAgda::OnNewMail(MOOSMSG_LIST &NewMail)
{
...
bool visualAgda::OnConnectToServer()
{
...
double visualAgda::distanceCalculate(double x1, double y1, double x2, double y2)
{
...
void visualAgda::RegisterVariables()
{
  // Register("FOOBAR", 0);
}
